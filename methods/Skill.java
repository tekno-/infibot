...
public enum Skill {
    ...
    public int getLevel() {
        return Game.getClient().getSkillLevelArray()[ordinal()];
    }

    public int getRealLevel() {
        return Game.getClient().getRealSkillLevelArray()[ordinal()];
    }
    public double getPercentage(){
        return getRealLevel() / getLevel() * 100.0D;
    }
    ...
    public int getExperienceToLevel(int level) {
        return XP_TABLE[level] - getExperience();
    }

    public int getExperience() {
        return Game.getClient().getSkillExpArray()[ordinal()];
    }
}
